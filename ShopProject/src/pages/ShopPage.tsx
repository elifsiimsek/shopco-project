                ...
                <div className="grid grid-cols-5 gap-4">
                  {availableColors.map((color) => (
                    <button
                      ...
                      className={`w-9 h-9 rounded-full border border-shopBlack/10 flex items-center justify-center transition-all cursor-pointer ${selectedColor === color.code ? "ring-2 ring-shopBlack ring-offset-4 scale-110" : "hover:scale-105"}`}
                    >
