    ...
    <>
      ...
      >
        <div className="flex justify-between items-center border-b p-6 bg-white shrink-0">
          <h2 className="text-xl font-[800] tracking-tighter">
            Filters
          </h2>
          <button
        ...
        <div className="flex-1 overflow-y-auto px-6 scrollbar-hide py-2 text-left">
          ...
          <div className="py-6 border-b border-[#F0F0F0]">
            <button
              ...
              className="w-full flex items-center justify-between mb-8 bg-transparent border-none cursor-pointer text-black font-[800] tracking-tighter"
            >
          ...
          <div className="py-6 border-b border-[#F0F0F0]">
            <button
              ...
              className="w-full flex items-center justify-between mb-4 bg-transparent border-none cursor-pointer text-black font-[800] tracking-tighter"
            >
        ...
        <div className="p-6 bg-white border-t shrink-0 flex flex-col gap-3">
          <button
            onClick={onClose}
            className="w-full rounded-full py-4 bg-black text-white font-black tracking-widest text-[11px] border-none cursor-pointer"
          >
            Apply Filter
          </button>
          <button
            onClick={onClear}
            className="bg-transparent border-none text-[11px] font-black tracking-widest text-black/30 hover:text-black transition-colors py-2 cursor-pointer text-center"
          >
            Clear All
          </button>
        </div>
