  ...
  <div className="flex-1 w-full border border-black/[0.08] rounded-[20px] p-5 md:p-6 bg-white space-y-6 text-black">
    {items.map((item, idx) => (
      <div
        ...
        className={`flex gap-4 relative ${idx !== items.length - 1 ? "border-b border-black/[0.08] pb-6" : ""}`}
      >
        ...
        <div className="flex-1 flex flex-col justify-between py-1 text-left relative z-10">
          ...
          <div className="flex justify-between items-end">
            ...
            <div className="flex items-center gap-6 bg-shopGray-light px-5 py-2.5 rounded-full font-black relative z-50">
              <button
                onClick={() =>
                  onDecrease(
                    String(item.id),
