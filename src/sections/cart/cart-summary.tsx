...
export const CartSummary = ({
  ...
  const deliveryFee = total > 300 || total === 0 ? 0 : 15;
      ...
      <div className="bg-white border border-black/[0.08] p-8 rounded-[32px] shadow-sm space-y-6 text-left">
        ...
        <div className="space-y-2">
          <div className="flex gap-3">
            <div
              className={`flex-1 flex items-center bg-shopGray-light px-4 py-4 rounded-full border transition-all ${promoError ? "border-red-500/50" : "border-black/[0.03] focus-within:border-black/20"}`}
            >
              <FiTag
