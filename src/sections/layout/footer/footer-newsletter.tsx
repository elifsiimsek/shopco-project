              ...
              <form onSubmit={handleSubmit} className="space-y-3" noValidate>
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full bg-white py-2.5 pl-12 pr-4 rounded-full outline-none text-[15px] border-2 transition-all text-black placeholder:text-black/40 ${
                      error
                ...
                <button
                  ...
                  className="w-full bg-white text-black py-2.5 rounded-full font-[600] text-[15px] hover:bg-gray-100 transition-all flex items-center justify-center gap-2 border-none cursor-pointer active:scale-95 disabled:opacity-50"
                >
                  {isSubmitting ? (
