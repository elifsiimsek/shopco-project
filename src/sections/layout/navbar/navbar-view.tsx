    ...
    <header className="w-full sticky top-0 z-[1000] shadow-sm bg-white font-satoshi">
      ...
      <nav className="w-full border-b border-black/[0.04] bg-white text-black">
        <div className="max-w-[1440px] mx-auto px-6 md:px-16 h-[64px] md:h-[80px] flex items-center justify-between gap-6 relative">
                  ...
                  <ul className="flex flex-col gap-1 list-none p-0 m-0 text-left text-black">
                    {shopCategories.map((c) => (
                      <li key={c.name}>
                        <Link
                          to={c.path}
                          className="block px-4 py-3 rounded-xl hover:bg-shopGray-light transition-all font-bold text-sm no-underline text-black/60 hover:text-black"
                        >
                          {c.name}
                        </Link>
                      </li>
          ...
          >
            <div className="flex items-center bg-shopGray-light px-5 py-3 rounded-full focus-within:ring-1 focus-within:ring-black/10 transition-all">
          ...
          >
            <div className="flex items-center bg-shopGray-light px-5 py-3 rounded-full mb-6 text-black">
              <FiSearch className="text-black/40 text-lg" />
              <input
                type="text"
