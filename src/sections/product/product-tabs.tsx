          ...
          <div className="animate-in fade-in duration-500">
            <div className="flex justify-between items-center mb-8">
              ...
              <div className="flex items-center gap-3">
                <button className="w-11 h-11 flex items-center justify-center bg-shopGray-light rounded-full border-none cursor-pointer hover:bg-black/5 transition-all text-black">
                  <SlidersHorizontal size={18} />
                </button>
                <div className="hidden md:flex items-center gap-4 bg-shopGray-light px-5 py-3 rounded-full font-bold text-[14px] cursor-pointer text-black">
